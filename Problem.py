...
class Problem:
    ...
    def update_boundary(self,new_types:list,
        ...
        self.boundary_conditions_types[neighbour.bound_index-1][neighbour.i_start:(neighbour.i_end+1)] = new_types
        self.boundary_conditions_values[neighbour.bound_index-1][neighbour.i_start:(neighbour.i_end+1)] = new_values
